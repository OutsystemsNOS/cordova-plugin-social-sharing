...
SocialSharing.prototype.shareIOS = function (message, fileUrl, successCallback, errorCallback) {
  cordova.exec(successCallback, this._getErrorCallback(errorCallback, "shareIOS"), "SocialSharing", "shareIOS", [message, fileUrl]);
};
